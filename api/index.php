...
$app->get('/api/admin/cards/{cardId}', [AdminCardController::class, 'getCard'])->add($adminAuth);
$app->post('/api/admin/cards/import', [AdminCardController::class, 'importCards'])->add($adminAuth);
$app->put('/api/admin/cards/edit/{cardId}', [AdminCardController::class, 'editCard'])->add($adminAuth);
$app->delete('/api/admin/cards/delete/{cardId}', [AdminCardController::class, 'deleteCard'])->add($adminAuth);
$app->get('/api/admin/tags/{tagId}', [AdminTagController::class, 'getTag'])->add($adminAuth);
$app->post('/api/admin/tags/create', [AdminTagController::class, 'createTag'])->add($adminAuth);
$app->put('/api/admin/tags/edit/{tagId}', [AdminTagController::class, 'editTag'])->add($adminAuth);
$app->delete('/api/admin/tags/delete/{tagId}', [AdminTagController::class, 'deleteTag'])->add($adminAuth);
$app->get('/api/admin/packs/{packId}', [AdminPackController::class, 'getPack'])->add($adminAuth);
$app->post('/api/admin/packs/create', [AdminPackController::class, 'createPack'])->add($adminAuth);
$app->put('/api/admin/packs/edit/{packId}', [AdminPackController::class, 'editPack'])->add($adminAuth);
$app->put('/api/admin/packs/toggle/{packId}', [AdminPackController::class, 'togglePack'])->add($adminAuth);
...
$app->delete('/api/admin/cards/{cardId}/tags/{tagId}', [AdminCardController::class, 'removeCardTag'])->add($adminAuth);
$app->get('/api/admin/cards/{cardId}/packs', [AdminCardController::class, 'getCardPacks'])->add($adminAuth);
$app->post('/api/admin/cards/{cardId}/packs/{packId}', [AdminCardController::class, 'addCardPack'])->add($adminAuth);
$app->delete('/api/admin/cards/{cardId}/packs/{packId}', [AdminCardController::class, 'removeCardPack'])->add($adminAuth);
